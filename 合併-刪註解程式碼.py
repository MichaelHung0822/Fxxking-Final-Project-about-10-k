...
tabControl.add(tab1, text='使用者資料')      
 
tab2 = ttk.Frame(tabControl)            
tabControl.add(tab2, text='搜尋內容')      
...
teacherChosen.current(0)  
teacherChosen.config(state='readonly')  
...
yearstChoice.current(0)  
yearstChoice.config(state='readonly')  
...
yearedChoice.config(state='readonly')  
yearL = tk.StringVar()
...
createToolTip(spinPart, '請設定關鍵字前後欲抓取的段落數')
